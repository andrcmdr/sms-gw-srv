// SMS Gateway Server :: SMPP client for the command line
//
...
// Author of smpp-cli
var Author = "Andrew Bednoff <andrcmdr@commandr.stream>"

func main() {
	app := cli.NewApp()
	app.Name = "sms-gw-srv-smpp-cli"
	app.Usage = "SMS Gateway Server :: SMPP client for the command line"
	app.Version = Version
	app.Author = Author
	app.Flags = []cli.Flag{
		cli.StringFlag{
...
var cmdShortMessage = cli.Command{
	...
	Action: func(c *cli.Context) {
		if len(c.Args()) < 3 {
			...
			fmt.Println("example: send --encoding ucs2 --register 7979 996775799799 Hello world!")
			return
		}
